    ...
    <div class="toolbar py-5 py-lg-5" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bold my-1 fs-3">Tambah Data Users</h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
                                ...
                                <div class="col-xl-12 mb-1">
                                    <form id="kt_modal_new_card_form m-5" class="form"
                                        ...
                                        <div class="d-flex flex-column mb-5 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                placeholder="Masukkan Nomor Induk Pegawai" name="nip" />
                                        </div>
                                        <div class="d-flex flex-column mb-5 fv-row">
                                            <div class="col-md-12 fv-row">
                                                <label class="required fs-6 fw-semibold form-label mb-2">Pilih
                                                    Jabatan</label>
                                                <select name="jabatan" class="form-select form-select-solid"
